...
$T=$t1-$t2;			
?>
<img src="images\rp.png" height="15px"><input type="text" name="dbal" id="dbal"  value="<?php echo $T;?>" style="background :transparent;color :red;width:120px;;font-weight:bold;" readonly>
