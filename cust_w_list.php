...
$data=mysqli_query($conn,"select * from main_cust where  sl>0 and typ='2' $all1 $brand1 $typ1 $sale_per1 $brncd1 order by nm limit $start,$ps ")or die(mysqli_error($conn));
