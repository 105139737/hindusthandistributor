...
<td align="center" hidden><b><?=$betno;?></b></td>
<td align="center" width="6%" ><b><?=$qty;?></b></td>
<td align="right" width="6%" ><b><?=round($mrp,2);?></b></td>			
<td align="right" width="8%" ><b><?=$total;?></b></td>
...
<td align="right" width="8%" ><b><?=round($ttl,2);?></b></td>
...
<td align="center" width="4%"><b><a onclick="if(confirm('Are you Sure?')){deltpr1('<?=$tsl;?>')}"><font color="red">Delete</font></a> </b></td>
</tr>
<?
$total_am+=$total;
$total_cgst+=$cgst_am;
