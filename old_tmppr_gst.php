...
<tr class="even">
<td  align="left" width="11%" onclick="get_data('<?=$tsl;?>','<?=$bcd;?>','<?=$prsl;?>','<?=$betno;?>','<?=$unit;?>','<?=$refno;?>','<?=$pcs;?>','<?=$prc;?>','<?=$total;?>','<?=$disp;?>','<?=$disa;?>','<?=$ttl;?>','<?=$cgst_rt;?>','<?=$cgst_am;?>','<?=$sgst_rt;?>','<?=$sgst_am;?>','<?=$igst_rt;?>','<?=$igst_am;?>','<?=$net_am;?>')" style="cursor:pointer;" title="Click Here To Edit" >
<b><?=$pnm;?></b>
</td>
<td  align="left" width="11%"><b><?=$bcdnm;?></b></td>
<td align="center" width="5%"><b></b><?=$betno;?></td>
