...
$pnm=$row1['pnm'];
	...
	<tr bgcolor="">
			...
			?>
			<a href="purchase_edit.php?blno=<?php echo $pbill;?>" target="_Blank"><?echo $pbill;?></a>
			<?}
			else
			{
			?>
			...
			<td  align="center"><b><a href="billing_edit.php?blno=<?php echo $sbill;?>" target="_Blank"><?echo $sbill;?></a></b></td>
